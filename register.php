...
<div class="logo">Newsification</div>
    ...
    <form action="login.php" method="post">
         <p style="color:white">Already have an account?</p>
          ...
          <input class="login-form" type="email" name="loginEmail" placeholder="Registerd Email" required>
            ...
            <button class="login-form" type="submit" name="btnLogin" value="Sign IN" style="background-color: #03997e;
					  color: White;" ><b>Sign In</b></button>
...
-->
<div style="font-family: Trebuchet MS; font-size:60px; margin-top: 20px; margin-bottom: 20px; text-align:center; color: White; ">Our features</div>
